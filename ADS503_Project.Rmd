...
author: "Hunter Blum, Brianne Bell, Eva Chow"
date: '2022-06-21'
output:
...
```{r message=FALSE, warning=FALSE}
set.seed(123)
Chol_ridge <- train(x = Chol_tr_X_imp_fin, y= Chol_train_y, method = "ridge", tuneGrid = expand.grid(lambda = seq(0, .5, length = 15)), trControl = Chol_control)
