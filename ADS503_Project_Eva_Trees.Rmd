...
```{r}
set.seed(123)
Chol_rf_model <- randomForest(Chol_train_y~ ., data = Chol_tr_X_imp_fin)
which.min(Chol_rf_model$mse)

Chol_rf <- train(x = Chol_tr_X_imp_fin, y = Chol_train_y, method = "rf", tuneLength = 15, trControl = Chol_control)
Chol_rf
plot(Chol_rf)
